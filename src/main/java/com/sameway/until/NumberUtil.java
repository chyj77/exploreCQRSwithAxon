...
/*	
	...
	*/
    ...
    public   static  String toPercent(BigDecimal s )  {
        double  p  = s.doubleValue();
        NumberFormat nf  =  NumberFormat.getPercentInstance();
        nf.setMinimumFractionDigits( 2 );
        String str  =  nf.format(p);
        return  str;
    ...
    public   static  BigDecimal percentToBigDecimal(String s ) throws ParseException {
        NumberFormat nf  =  NumberFormat.getPercentInstance();
        return formatBigDecimal(nf.parse(s));
    }

    public   static  Number percentToNumber(String s ) throws ParseException {
        NumberFormat nf  =  NumberFormat.getPercentInstance();
        return nf.parse(s);
    }


    public static String percentDiscount(String s1,String s2) throws ParseException {
        NumberFormat nf  =  NumberFormat.getPercentInstance();
        double d1=nf.parse(s1).doubleValue();
        double d2=nf.parse(s2).doubleValue();
        return  NumberUtil.format(d1/d2*10,1);
    }
    ...
    public static String numberToYi(BigDecimal bigDecimal){

        String str ="";
        if (bigDecimal==null)
            return str;
        str=format(bigDecimal.divide(
